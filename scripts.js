...
function iniciarLeitura() {
    ...
    Quagga.init({
        ...
        decoder: {
            readers: ["ean_reader"] // Leitor de códigos de barras EAN
        }
    }, function (err) {
        if (err) {
            console.error(err);
    ...
    // Evento que captura o código de barras lido
    Quagga.onDetected(function (result) {
        const codigo = result.codeResult.code;
        document.getElementById('codigoBarras').value = codigo; // Preenche o campo com o código lido
        pararLeitura(); // Para a leitura após capturar o código
...
function pararLeitura() {
    Quagga.stop();
    document.getElementById('camera-container').style.display = 'none'; // Oculta o container da câmera
}